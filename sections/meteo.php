...
<section id="section-meteo" data-custom-anim="true" class="section absolute inset-0 w-full h-full bg-white text-[#1a1a1a] overflow-hidden flex flex-col p-12">
    ...
    <div class="flex-none flex items-end justify-between mb-8 border-b border-gray-100 pb-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <button id="refresh-btn" class="ml-4 w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300">
    ...
    <div class="flex-1 flex flex-col gap-6 min-h-0">
        ...
        <div class="flex-[1.6] grid grid-cols-12 gap-6 min-h-0">
            ...
            <div class="col-span-4 flex flex-col gap-6 min-h-0">
                <!-- KPI Box -->
                <div class="flex-1 bg-white rounded-xl border border-gray-100 p-6 flex flex-col justify-center items-center text-center group transition-colors duration-500">
                ...
                <!-- Sun Chart -->
                <div class="flex-[0.8] bg-white rounded-xl border border-gray-100 p-6 flex flex-col relative group transition-colors duration-500 overflow-hidden">
        ...
        <div class="flex-1 bg-white rounded-xl border border-gray-100 p-6 flex flex-col relative transition-colors duration-500 overflow-hidden">
